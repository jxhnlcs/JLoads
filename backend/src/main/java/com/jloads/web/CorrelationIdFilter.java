...
/**
 * Propaga um correlation ID por requisição (header {@value #HEADER}). Valores recebidos só são aceitos se
 * tiverem formato seguro, evitando injeção de conteúdo nos logs.
 */
@Component
